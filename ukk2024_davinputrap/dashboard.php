<?php
    ...
    $count_kategori = mysqli_query($conn, "SELECT COUNT(*) AS total FROM tb_album");
...
<body>
    ...
    <!-- Display the count of photos and categories -->
    <div class="section">
        <div class="container">
            <h3>Statistik Galeri</h3>
            <p>Jumlah Foto: <?php echo $total_foto; ?></p>
            <p>Jumlah Kategori: <?php echo $total_kategori; ?></p>
        </div>
    </div>
     <!-- category -->
 <!--   <div class="section">
